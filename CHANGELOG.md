...
- Migrated the Jest/Babel test configuration for Babel 8 compatibility.
- Removed unused `ts-jest` configuration and dependency.
- Applied npm audit security fixes.
...
- Updated dependencies.
- Added small improvements to code coverage tests.

### Added

- Chapbook 2.3.1 to official story formats.
